...
function start1(input1,roomslen,occ_patt,true_load,eff,total_true_load,roomsArray) {
 ...
 input1.forEach((element,index)=>{
  ...
  display_price = 0
    element.forEach(elementinner=>{
      display_product_img = elementinner.condenserid.ImagePath.toString()
      display_price = display_price + Number(elementinner.condenserid.Price)
      condenserImg.push(elementinner.condenserid.ImagePath)
      ...
      let obj  = {
        ...
        "pump": Number(element.monthy_operating_power/30).toFixed(2).toString(),
    ...
    let obj = {
          ...
          "display_monthly_operating_power": (element.monthy_operating_power/1000).toFixed(2),
          "display_price": display_price.toString(),
          "display_yearly_electricity_cost": (element.yearly_electricity_cost).toFixed(2).toString(),
          "display_monthly_electricity_cost": (element.monthly_electricity_cost).toFixed(2).toString(),
...
let energyWise =  energyTemp.sort((a, b) => {
  return Number(a.display_monthly_operating_power) - Number(b.display_monthly_operating_power);
})

    ...
    request.query(query, function (err, recordset) {
        ...
        if (!err) {
            ...
            res.json({
                ...
                message: "Successfully got form GetProductList",
                result: {
                    PopularProductsFCUList: finalFCU.sort((a, b) => a.count - b.count),
                    PopularProductsCondensorList: final.sort((a, b) => a.count - b.count)
                }
...
function getOrderID(id) {
    ...
    return new Promise((resolve, reject) => {
        // //console.log("rqyert", `select Id from orderList where UserId = '${id}' and OrderStatus = 'PE'`)
        request.query(`select Id from orderList where UserId = '${id}' and OrderStatus <> 'CA'`, function (err, recordset) {
